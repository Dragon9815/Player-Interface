package net.stegr.repackage.cofh.lib.world;

import static net.stegr.repackage.cofh.lib.world.WorldGenMinableCluster.*;
import static java.lang.Math.abs;

import net.stegr.repackage.cofh.lib.util.WeightedRandomBlock;
import net.stegr.repackage.cofh.lib.util.WeightedRandomNBTTag;
