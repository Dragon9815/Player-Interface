...
import static net.stegr.repackage.cofh.lib.world.WorldGenMinableCluster.canGenerateInBlock;

import net.stegr.repackage.cofh.lib.util.WeightedRandomBlock;
import net.stegr.repackage.cofh.lib.util.helpers.BlockHelper;
