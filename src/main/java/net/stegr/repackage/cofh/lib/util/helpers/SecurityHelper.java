...
public class SecurityHelper {
	...
	public static void addOwnerInformation(ItemStack stack, List<String> list) {
		...
		if (SecurityHelper.isSecure(stack)) {
			...
			if (!stack.stackTagCompound.hasKey("Owner") && !hasUUID) {
				list.add(StringHelper.localize("info.net.stegr.repackage.cofh.owner") + ": " + StringHelper.localize("info.net.stegr.repackage.cofh.none"));
			} else {
				if (hasUUID && stack.stackTagCompound.hasKey("Owner")) {
					list.add(StringHelper.localize("info.net.stegr.repackage.cofh.owner") + ": " + stack.stackTagCompound.getString("Owner"));
				} else {
					list.add(StringHelper.localize("info.net.stegr.repackage.cofh.owner") + ": " + StringHelper.localize("info.net.stegr.repackage.cofh.anotherplayer"));
				}
			}
		}
	}
	...
	public static void addAccessInformation(ItemStack stack, List<String> list) {
		...
		if (SecurityHelper.isSecure(stack)) {
			...
			case 0:
				accessString = StringHelper.localize("info.net.stegr.repackage.cofh.accessPublic");
				break;
			case 1:
				accessString = StringHelper.localize("info.net.stegr.repackage.cofh.accessRestricted");
				break;
			case 2:
				accessString = StringHelper.localize("info.net.stegr.repackage.cofh.accessPrivate");
				break;
			}
			list.add(StringHelper.localize("info.net.stegr.repackage.cofh.access") + ": " + accessString);
		}
	}
	...
	public static String getOwnerName(ItemStack stack) {
		...
		return hasUUID ? stack.stackTagCompound.getString("Owner") : StringHelper.localize("info.net.stegr.repackage.cofh.anotherplayer");
	}
