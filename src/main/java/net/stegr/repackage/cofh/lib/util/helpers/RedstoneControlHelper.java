...
public class RedstoneControlHelper {
	...
	public static void addRSControlInformation(ItemStack stack, List<String> list) {
		...
		if (hasRSControl(stack)) {
			...
			case 0:
				list.add(StringHelper.localize("info.net.stegr.repackage.cofh.signal") + ": " + StringHelper.RED + StringHelper.localize("info.net.stegr.repackage.cofh.disabled") + StringHelper.END);
				return;
			case 1:
				list.add(StringHelper.localize("info.net.stegr.repackage.cofh.signal") + ": " + StringHelper.BRIGHT_GREEN + StringHelper.localize("info.net.stegr.repackage.cofh.enabled")
						+ StringHelper.LIGHT_GRAY + ", " + StringHelper.localize("info.net.stegr.repackage.cofh.low") + StringHelper.END);
				return;
			case 2:
				list.add(StringHelper.localize("info.net.stegr.repackage.cofh.signal") + ": " + StringHelper.BRIGHT_GREEN + StringHelper.localize("info.net.stegr.repackage.cofh.enabled")
						+ StringHelper.LIGHT_GRAY + ", " + StringHelper.localize("info.net.stegr.repackage.cofh.high") + StringHelper.END);
				return;
			}
		}
	}
