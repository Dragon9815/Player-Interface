...
public final class StringHelper {
	...
	public static String shiftForDetails() {
		...
		return LIGHT_GRAY + localize("info.net.stegr.repackage.cofh.hold") + " " + YELLOW + ITALIC + localize("info.net.stegr.repackage.cofh.shift") + " " + END + LIGHT_GRAY
				+ localize("info.net.stegr.repackage.cofh.forDetails") + END;
	}

	/* TUTORIAL TAB HELPERS */
	public static String tutorialTabAugment() {

		return localize("info.net.stegr.repackage.cofh.tutorial.tabAugment");
	}

	public static String tutorialTabConfiguration() {

		return localize("info.net.stegr.repackage.cofh.tutorial.tabConfiguration.0");
	}

	public static String tutorialTabConfigurationEnergy() {

		return localize("info.net.stegr.repackage.cofh.tutorial.tabConfiguration.1");
	}

	public static String tutorialTabConfigurationOperation() {

		return localize("info.net.stegr.repackage.cofh.tutorial.tabConfiguration.2");
	}

	public static String tutorialTabRedstone() {

		return localize("info.net.stegr.repackage.cofh.tutorial.tabRedstone");
	}

	public static String tutorialTabSecurity() {

		return localize("info.net.stegr.repackage.cofh.tutorial.tabSecurity");
	}

	public static String tutorialTabFluxRequired() {

		return localize("info.net.stegr.repackage.cofh.tutorial.fluxRequired");
	}
