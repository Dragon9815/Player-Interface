...
public abstract class BlockTileEntityUpgradeable extends BlockTileEntityBase implements IBlockUpgradeable
{
    public BlockTileEntityUpgradeable()
    {
        super();
    }

    public BlockTileEntityUpgradeable(Material material)
    {
        super(material);
    }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int meta, float par7, float par8, float par9)
    {
        if(!world.isRemote)
        {
            net.stegr.playerinterfacemod.tileentity.TileEntityUpgradeable te = (net.stegr.playerinterfacemod.tileentity.TileEntityUpgradeable) world.getTileEntity(x, y, z);
